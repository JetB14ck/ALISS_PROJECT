...
namespace ALISS.MasterManagement.Api.Controllers
{
    ...
    public class SpecimenController : Controller
    {
        ...
        [HttpPost]
        [Route("api/Specimen/Get_List_Mapping_Active_ByModel")]
        public IEnumerable<SpecimenDTO> GetList_Mapping_Active_WithModel([FromBody]SpecimenDTO searchModel)
        {
            var objReturn = _service.GetList_Mapping_Active_WithModel(searchModel);
