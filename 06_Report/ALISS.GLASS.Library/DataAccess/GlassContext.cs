...
namespace ALISS.GLASS.Library.DataAccess
{
    public class GlassContext : DbContext
    {
        ...
        public DbSet<GlassAnalyzeListDTO> DropdownGlassAreaHealthAnalyzeDTOs { get; set; }
        public DbSet<GlassAnalyzeListDTO> DropdownGlassHospitalAnalyzeDTOs { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<GlassAnalyzeListDTO>().HasNoKey();
