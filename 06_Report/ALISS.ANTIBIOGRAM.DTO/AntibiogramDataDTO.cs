...
namespace ALISS.ANTIBIOGRAM.DTO
{
    ...
    public class AntiProvinceSearchDTO
    {
        public string prv_code { get; set; }
        public string arh_code { get; set; }
        public string spc_code { get; set; }
    ...
    public class OrganismGroupDTO
    {
        ...
        public string org_specimen { get; set; }
        public string org_gram { get; set; }
        public string org_macro_name { get; set; }
        public string org_row_name { get; set; }
        public string org_organism_label { get; set; }
    }
}
