...
namespace ALISS.ANTIBIOGRAM.Api.Controllers
{
    ...
    public class AntibiogramController : Controller
    {
        ...
        [HttpPost]
        [Route("api/Antibiogram/GetAntiProvinceTemplateModel")]
        public IEnumerable<AntibiogramProvinceTemplateDTO> GetAntibiogramProvinceTemplateModel([FromBody]AntiProvinceSearchDTO searchModel)
        {
            var objReturn = _service.GetAntibiogramProvinceTemplateWithModel(searchModel);
