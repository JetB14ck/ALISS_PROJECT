...
namespace ALISS.ANTIBIOGRAM.Library
{
    public class AntibiogramService : IAntibiogramService
    {
        ...
        public List<AntibiogramProvinceTemplateDTO> GetAntibiogramProvinceTemplateWithModel(AntiProvinceSearchDTO searchModel)
        {
            log.MethodStart();
            ...
            using (var trans = _db.Database.BeginTransaction())
            {
                try
                {
                    var objDataList = _db.DropdownProvinceTemplateListDTOs.FromSqlRaw<AntibiogramProvinceTemplateDTO>("sp_GET_RPAntibiogramProvinceTemplateFile {0},{1},{2},{3},{4}"
                                                                                                , searchModel.prv_code
                                                                                                , searchModel.arh_code
                                                                                                , searchModel.spc_code
                                                                                                , searchModel.start_date_str
                    ...
                    objList = _mapper.Map<List<AntibiogramProvinceTemplateDTO>>(objDataList);
