...
namespace ALISS.ANTIBIOGRAM.Library
{
    ...
    {    
        ...
        List<AntibiogramDataDTO> GetAntibiogramProvinceData();
        List<AntibiogramDataDTO> GetAntibiogramProvinceDataWithModel(AntiProvinceSearchDTO searchModel);
        ...
        List<OrganismGroupDTO> GetOrganismGroupWithModel();
        List<OrganismGroupDTO> GetOrganismGroupNameWithModel();
    }
}
