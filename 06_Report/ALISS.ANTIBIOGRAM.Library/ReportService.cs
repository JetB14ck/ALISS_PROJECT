   ...
   public class ReportService : IReportService
    {
        ...
        public List<AntibiogramDataDTO> GetAntibiogramProvinceData()
        {
            log.MethodStart();
            ...
            using (var trans = _db.Database.BeginTransaction())
            {
                try
                {
                    objList = _db.DropdownListDTOs.FromSqlRaw<AntibiogramDataDTO>("sp_GET_RPAntibiogramProvince").ToList();
        ...
        public List<AntibiogramDataDTO> GetAntibiogramProvinceDataWithModel(AntiProvinceSearchDTO searchModel)
        {
            log.MethodStart();
            ...
            using (var trans = _db.Database.BeginTransaction())
            {
                try
                {
                    var objDataList = _db.DropdownListDTOs.FromSqlRaw<AntibiogramDataDTO>("sp_GET_RPAntibiogramProvince {0},{1},{2},{3},{4},{5}"
                                                                                                , searchModel.prv_code
                                                                                                , searchModel.arh_code
                                                                                                , searchModel.spc_code
                                                                                                , null
        ...
        public List<OrganismGroupDTO> GetOrganismGroupWithModel()
        {
            log.MethodStart();

            List<OrganismGroupDTO> objList = new List<OrganismGroupDTO>();

            using (var trans = _db.Database.BeginTransaction())
            {
                try
                {
                    objList = _db.OrganismGroupDTOs.FromSqlRaw<OrganismGroupDTO>("select * from V_RP_OrganismGroupName").Where(w=>w.org_specimen == "All Specimen").OrderBy(s=> s.org_organism_label).ToList();

                    //objList = _mapper.Map<List<OrganismGroupDTO>>(objDataList);
        ...
        public List<OrganismGroupDTO> GetOrganismGroupNameWithModel()
        {
            log.MethodStart();
            ...
            using (var trans = _db.Database.BeginTransaction())
            {
                try
                {
                    objList = _db.OrganismGroupDTOs.FromSqlRaw<OrganismGroupDTO>("sp_GET_OrganismGroupName").ToList();
