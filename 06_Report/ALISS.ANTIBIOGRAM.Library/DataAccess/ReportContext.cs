...
namespace ALISS.ANTIBIOGRAM.Library.DataAccess
{
    public class ReportContext : DbContext
    {
        ...
        public DbSet<AntibiogramProvinceTemplateDTO> DropdownProvinceTemplateListDTOs { get; set; }
        ...
        public DbSet<OrganismGroupDTO> OrganismGroupDTOs { get; set; }
