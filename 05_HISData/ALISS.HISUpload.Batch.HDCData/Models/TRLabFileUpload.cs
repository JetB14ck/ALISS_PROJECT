...
namespace ALISS.HISUpload.Batch.HDCData.Models
{
    public class TRLabFileUpload
    {
        ...
        public string lfu_ProcessStatus { get; set; }
        public string lfu_LabAlertStatus { get; set; }
        public List<TRSTGLabFileDataHeader> TRSTGLabFileDataHeaderList { get; set; } = new List<TRSTGLabFileDataHeader>();
    }
}
