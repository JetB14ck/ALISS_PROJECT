    ...
    public class GLASS_File
    {
        ...
        public string DATE_DATA
        {
            get
            {
                ...
                else if (huh_date != null)
                {
                    strReturn = huh_date.Value.ToString("yyyy-MM-dd HH:mm:sss");
                }
                return strReturn;
            }
        }
        public string COMMENT { get; set; }
        public string CORGANISM137 { get; set; }
        public string FULLNAME { get; set; }
        public string LOCAL_SPEC { get; set; }
        public string NOSOCOMIAL { get; set; }
        public string DATE_ADMIS_STR { get; set; }
        public string DATE_ADMIS 
        {
            get
            {
                var strReturn = "";
                if (string.IsNullOrEmpty(DATE_ADMIS_STR) == false)
                {
                    string format1 = "M/d/yyyy H:mm:ss";
                    string format2 = "M/d/yyyy H:mm:ss tt";
                    string format3 = "M/d/yyyy H:mm:sss";
                    ...
                    string format5 = "M/d/yyyy";
                    DateTime tmpFieldValue;
                    if (DateTime.TryParseExact(DATE_ADMIS_STR, format1, System.Globalization.CultureInfo.GetCultureInfo("en-US"), System.Globalization.DateTimeStyles.None, out tmpFieldValue))
                    {
                        strReturn = tmpFieldValue.ToString("yyyy-MM-dd HH:mm:sss");
                    }
                    else if (DateTime.TryParseExact(DATE_ADMIS_STR, format2, System.Globalization.CultureInfo.GetCultureInfo("en-US"), System.Globalization.DateTimeStyles.None, out tmpFieldValue))
                    {
                        strReturn = tmpFieldValue.ToString("yyyy-MM-dd HH:mm:sss");
                    }
                    else if (DateTime.TryParseExact(DATE_ADMIS_STR, format3, System.Globalization.CultureInfo.GetCultureInfo("en-US"), System.Globalization.DateTimeStyles.None, out tmpFieldValue))
                    {
                        strReturn = tmpFieldValue.ToString("yyyy-MM-dd HH:mm:sss");
                    }
                    else if (DateTime.TryParseExact(DATE_ADMIS_STR, format4, System.Globalization.CultureInfo.GetCultureInfo("en-US"), System.Globalization.DateTimeStyles.None, out tmpFieldValue))
                    {
                        strReturn = tmpFieldValue.ToString("yyyy-MM-dd HH:mm:sss");
                    }
                    else if (DateTime.TryParseExact(DATE_ADMIS_STR.Split(' ')[0], format5, System.Globalization.CultureInfo.GetCultureInfo("en-US"), System.Globalization.DateTimeStyles.None, out tmpFieldValue))
                    {
                        strReturn = tmpFieldValue.ToString("yyyy-MM-dd HH:mm:sss");
                    }
                    else
