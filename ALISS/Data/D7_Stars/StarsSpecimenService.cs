...
{
    public class StarsSpecimenService
    {
        private IConfiguration Configuration { get; }

        private ApiHelper _apiHelper;

        public StarsSpecimenService(IConfiguration configuration)
        {
        ...
        public async Task<List<SpecimenDTO>> GetListByModelMappingActiveAsync(SpecimenDTO searchData)
        {
            List<SpecimenDTO> objList = new List<SpecimenDTO>();

            objList = await _apiHelper.GetDataListByModelAsync<SpecimenDTO, SpecimenDTO>("specimen_api/Get_List_Mapping_Active_ByModel", searchData);
