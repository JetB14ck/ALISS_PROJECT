...
namespace ALISS.Data.D0_Master
{
    public class HomeService
    {
        ...
        public async Task<List<TRNoticeMessageDTO>> GetListByModelByRoleAsync(TRNoticeMessageDTO searchData)
        {
            List<TRNoticeMessageDTO> objList = new List<TRNoticeMessageDTO>();

            objList = await _apiHelper.GetDataListByModelAsync<TRNoticeMessageDTO, TRNoticeMessageDTO>("noticemessage_api/Get_ListByModelByRole", searchData);
