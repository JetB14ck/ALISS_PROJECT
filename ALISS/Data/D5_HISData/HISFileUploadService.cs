...
namespace ALISS.Data.D5_HISData
{
    public class HISFileUploadService
    {
        ...
        {
            //Temp SearchModel
            TRSPWithHISSearchDTO models = new TRSPWithHISSearchDTO();
            models.lfu_id = string.Empty;
            models.hos_code = model.hos_code;
            models.lab_code = model.lab_no;
            models.start_date = model.start_date;
            models.end_date = model.end_date;


            //models.hos_code = "001071600";
            //models.lab_code = "10001";
            //models.start_date = DateTime.Parse("2019-01-01");
            //models.end_date = DateTime.Parse("2021-12-31");
            ...
            tRSPWithHISDetails = await _apiHelper.GetDataListByModelAsync<TRSPWithHISDetailDTO, TRSPWithHISSearchDTO>("his_api/GetTRSPWithHISDetail", models);
            ...
            using (var package = new ExcelPackage())
            {
                ...
                {
                    idxRowCurrent++;
                    workSheet.Cells[idxRowCurrent, idxColRef].Value = tRSPWithHISDetail.ref_no;
                    workSheet.Cells[idxRowCurrent, idxColHN].Value = tRSPWithHISDetail.hn;
                    workSheet.Cells[idxRowCurrent, idxColLabNo].Value = tRSPWithHISDetail.lab_no;
                    workSheet.Cells[idxRowCurrent, idxColSpcDate].Value = tRSPWithHISDetail.date;
                    workSheet.Cells[idxRowCurrent, idxColSpcDate].Style.Numberformat.Format = "dd-MM-yyyy";
                ...
                //    var objWhonetHISFields = objWhonetHIS.Select(s => s.wnc_code).ToList();
                ...
                //        idxRowCurrent++;
                //        workSheet.Cells[idxRowCurrent, idxColRef].Value = tRSPWithHISDetail.ref_no;
                //        workSheet.Cells[idxRowCurrent, idxColHN].Value = tRSPWithHISDetail.hn_no;
                //        workSheet.Cells[idxRowCurrent, idxColLabNo].Value = tRSPWithHISDetail.lab_no;
                //        workSheet.Cells[idxRowCurrent, idxColSpcDate].Value = tRSPWithHISDetail.date;
                //        workSheet.Cells[idxRowCurrent, idxColSpcDate].Style.Numberformat.Format = "dd-MM-yyyy";

                //        int idxColCurrent = 5;
                //        foreach (var colName in objWhonetHISFields.ToArray())
                //        {
                //            if (typeof(TRSPWithHISDetailDTO).GetProperty(colName) != null)
                //            {
                //                workSheet.Cells[idxRowCurrent, idxColCurrent].Value = typeof(TRSPWithHISDetailDTO).GetProperty(colName).GetValue(tRSPWithHISDetail);
                //                if (typeof(TRSPWithHISDetailDTO).GetProperty(colName).PropertyType == typeof(DateTime?))
                //                    workSheet.Cells[idxRowCurrent, idxColCurrent].Style.Numberformat.Format = "dd-MM-yyyy";
                //            }
                //            idxColCurrent++;
                //        }
