...
namespace ALISS.Data.D6_Report.Antibiogram
{
    public class ReportService
    {
        ...
        public async Task<List<AntibiogramDataDTO>> GetAntibiogramProvinceListAsync()
        {
            List<AntibiogramDataDTO> objList = new List<AntibiogramDataDTO>();

            objList = await _apiHelper.GetDataListAsync<AntibiogramDataDTO>("report_api/GetAntiProvince");

            return objList;
        }
        public async Task<List<AntibiogramDataDTO>> GetAntibiogramProvinceListModelAsync(AntiProvinceSearchDTO searchData)
        {
            List<AntibiogramDataDTO> objList = new List<AntibiogramDataDTO>();

            objList = await _apiHelper.GetDataListByModelAsync<AntibiogramDataDTO, AntiProvinceSearchDTO>("report_api/GetAntiProvinceModel", searchData);
        ...
        public async Task<List<OrganismGroupDTO>> GetOrganismGroupAsync()
        {
            List<OrganismGroupDTO> objList = new List<OrganismGroupDTO>();

            objList = await _apiHelper.GetDataListAsync<OrganismGroupDTO>("report_api/GetOrganismGroupModel");

            return objList;
        }
        public async Task<List<OrganismGroupDTO>> GetOrganismGroupNameAsync()
        {
            List<OrganismGroupDTO> objList = new List<OrganismGroupDTO>();

            objList = await _apiHelper.GetDataListAsync<OrganismGroupDTO>("report_api/GetOrganismGroupNameModel");
