...
namespace ALISS.Data.D3_Process
{
    public class ProcessRequestService
    {
        ...
        public async Task<List<ProcessRequestCheckDetailDTO>> GetCheckDetailListByParamAsync(ProcessRequestDTO searchData)
        {
            List<ProcessRequestCheckDetailDTO> objList = new List<ProcessRequestCheckDetailDTO>();

            objList = await _apiHelper.GetDataListByModelAsync<ProcessRequestCheckDetailDTO, ProcessRequestDTO>("processrequest_api/Get_CheckDetailListByParam", searchData);
