...
namespace ALISS.LabFileUpload.Library.DataAccess
{
    public class LabFileUploadContext : DbContext
    {
        ...
        public DbSet<LabFileLabAlertSummaryListDTO> LabFileLabAlertSummaryListDTOs { get; set; }
        public DbSet<LabFileExportMappingErrorDTO> LabFileExportMappingErrorDTOs { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<LabFileLabAlertSummaryListDTO>().HasKey(x => x.plas_id);

            builder.Entity<TRLabFileUpload>().HasKey(x => x.lfu_id);
            builder.Entity<TRLabFileUpload>().ToTable("TRLabFileUpload");


            builder.Entity<LabFileExportMappingErrorDTO>()
                .HasNoKey();
