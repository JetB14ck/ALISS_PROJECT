            ...
            try
            {
                ...
                if (LabFileUpload != null)
                {
                    ...
                    if (ParameterPathList.Count != 0)
                    {
                        ...
                        next_header_id = Convert.ToInt32(ParameterPathList.FirstOrDefault(x => x.prm_code_minor == "MAX_HEADER_KEY").prm_value)+1;
                    }
                    //ดัก approve
...
AddDetailPoint:
                                ...
                                if (LabFileDataHeaderList.Count() != 0)
                                {
                                    ...
                                    LabDataDAL.UpdateMaxHeaderKey(next_header_id);
